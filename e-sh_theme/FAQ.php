...
<html class="no-js" lang="en">
  ...
  <body class="royal_loader">
    ...
    <?php
    include "page-parts/header-nav.php"
    ?>
    <main class="cd-main-content">
      ...
      <div class="section padding-bottom">
        <div class="container">
          ...
          <div class="lat-pro">
          <a href="#"><div class="lat-pro-img"><img  src="img/portfolio/a1.jpg" alt="" /></div></a>
          <a href="#"><div class="lat-pro-img"><img  src="img/portfolio/a2.jpg" alt="" /></div></a>
          <a href="#"><div class="lat-pro-img"><img  src="img/portfolio/b1.jpg" alt="" /></div></a>
          <a href="#"><div class="lat-pro-img"><img  src="img/portfolio/b2.jpg" alt="" /></div></a>
          </div>
          <div class="separator-sidebar"></div>
          <h6>Latest Video</h6>
    ...
    <?php
    include "page-parts/scripts.php"
    ?>
